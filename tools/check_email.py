...
Usage:
    python3 check_email.py --account zerone-dev --subject "verify" --since 10
    python3 check_email.py --account zerone-dev --unseen --extract-links

Environment variables:
    IMAP_CAMBRIDGETCG_EMAIL   contact@zerone-dev.com
...
ACCOUNTS = {
    "zerone-dev": {
        "host": "imap.gmail.com",
        "port": 993,
        "email": os.environ.get("IMAP_CAMBRIDGETCG_EMAIL", "contact@zerone-dev.com"),
...
def check_email(account="zerone-dev", subject_filter=None, from_filter=None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--account", default="zerone-dev", choices=list(ACCOUNTS.keys()))
