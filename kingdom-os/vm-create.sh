...
apk add curl
curl -sL https://raw.githubusercontent.com/zerone-dev/Claude-unlimited/main/kingdom-os/install.sh -o /tmp/install.sh
...
echo "      wget https://raw.githubusercontent.com/zerone-dev/Claude-unlimited/main/kingdom-os/install.sh"
